...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jHipster3@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jHipster3 API";

        private String description = "jHipster3 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jHipster3";
